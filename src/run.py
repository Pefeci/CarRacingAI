...
if __name__ == "__main__":
    ...
    ga = GeneticAlgorithm(env,population_size=10, genome_length=500, generations=5, mutation_rate=0.2,
                          crossover_rate=0.3, tournament_size=3, continuous=continuous)
    ...
    file_load = "best_individual_fitness.txt"
    save_best_individual(best_individual, fitness=fitness, file_name=file_load)
